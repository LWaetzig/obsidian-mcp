/**
 * Folder management tools exposed to MCP clients.
 *
 * Hidden directories (those starting with `.`) such as `.obsidian` and
 * `.trash` are automatically excluded from all results.
 *
 * **Tools registered here:**
 * - `obsidian_list_folders` — list all subdirectories with note counts
 * - `obsidian_create_folder` — create a folder (idempotent, creates parents as needed)
 *
