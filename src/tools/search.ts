/**
 * Search tools exposed to MCP clients.
 *
 * Provides three complementary ways to locate notes across the vault.
 * All searches are paginated and return vault-relative paths.
 *
 * **Tools registered here:**
 * - `obsidian_search_notes` — case-insensitive full-text search with context excerpts
 * - `obsidian_search_by_tag` — find all notes carrying a specific tag
 * - `obsidian_get_backlinks` — find all notes linking to a given note via `[[wikilinks]]`
 *
