...
/**
 * Format note metadata as Markdown or JSON.
 *
 * @param note - Note metadata to format.
 * @param format - Output format (`markdown` or `json`).
 * @returns Formatted string ready for inclusion in an MCP tool response.
 */
...
/**
 * Format full note content (body + metadata) as Markdown or JSON.
 *
 * Long responses are truncated at {@link CHARACTER_LIMIT} characters with a
 * visible notice appended.
 *
 * @param note - Full note content including body and raw source.
 * @param format - Output format (`markdown` or `json`).
 * @returns Formatted string ready for inclusion in an MCP tool response.
 */
...
/**
 * Format a paginated list of notes as Markdown or JSON.
 *
 * @param result - Paginated note metadata result.
 * @param format - Output format (`markdown` or `json`).
 * @returns Formatted string ready for inclusion in an MCP tool response.
 */
...
/**
 * Format paginated search or backlink results as Markdown or JSON.
 *
 * @param result - Paginated search matches.
 * @param label - The original query or note path, used as a heading label.
 * @param format - Output format (`markdown` or `json`).
 * @returns Formatted string ready for inclusion in an MCP tool response.
 */
...
/**
 * Format a flat list of folders as Markdown or JSON.
 *
 * @param folders - Array of folder info objects to render.
 * @param format - Output format (`markdown` or `json`).
 * @returns Formatted string ready for inclusion in an MCP tool response.
 */
